...
- (BOOL)migrate:(Database *)database {
    ...
    return [PaymentMethodsHelper createTableInQueue:queue]
            && [queue executeUpdateWithStatementComponents:alterTrips]
            && [queue executeUpdateWithStatementComponents:alterReceipts];
}
