...
class ReceiptsInteractor: Interactor {
    ...
    func titleSubtitle() -> TitleSubtitle {
        ...
        if WBPreferences.showReceiptID() {
            ...
            subtitle = String(format: LocalizedString("next_id"), id)
        } else {
            ...
            subtitle = String(format: LocalizedString("daily_total"), priceCollection.currencyFormattedTotalPrice(ignoreEmpty: false))
        }
